...
@click.command()
@click.option('--images_dir', default = "images", type=str, help='Input dir for calibration images')
@click.option('--dir_path', default= "data", type=str, help='Output dir for calibration file')
...
@click.option('--yaml_name', default = "chessboard_calibration.yml", type=str, help='Name of calibration file')
...
def main(images_dir, dir_path, width, height, square_size, yaml_name):
    ...
    ret, mtx, dist, rvecs, tvecs, imgs_idxs, (H, W) = calibrate_chessboard(images_dir, square_size, width, height)
