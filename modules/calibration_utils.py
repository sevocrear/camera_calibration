...
def load_coefficients(path, export_R_T = False):
    ...
    cv_file.release()
    return [camera_matrix, new_camera_matrix, dist_matrix, roi, rotation_matrix, translation_vector]

def save_coefficients(mtx, newcameramtx, roi, dist, path, rot_mtx = None, trans_vect = None, resize_x = 1, resize_y = 1):
